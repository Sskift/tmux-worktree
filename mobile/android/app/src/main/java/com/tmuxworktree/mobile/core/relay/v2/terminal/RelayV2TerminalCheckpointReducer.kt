...
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.parseCounter
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.parsePositiveCounter
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.addCounter
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.incrementCounter
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.validateCheckpoint
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.pendingOutputBytes
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.pendingInputBytes
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.ZERO
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.ONE
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.validOperationId
import com.tmuxworktree.mobile.core.relay.v2.terminal.RelayV2TerminalCheckpointValidation.CheckpointValidity
...
internal object RelayV2TerminalCheckpointReducer {
    ...
    internal fun pendingResumeMatchesTimeline(
        checkpoint: RelayV2TerminalCheckpoint,
    ...
    internal fun resetResultAdvancesAuthority(
        pending: RelayV2TerminalPendingOpen,
        identity: RelayV2TerminalIdentity,
    ...
    internal fun RelayV2TerminalCheckpoint.hasConsumedNullResetPredecessor(): Boolean =
    ...
    internal fun validRequestIdHistory(
        issued: List<String>,
    ...
    internal fun dispositionMatches(
        mode: RelayV2TerminalOpenMode,
    ...
    internal fun retainedBufferCovers(
    ...
    internal fun validCloseTombstone(tombstone: RelayV2TerminalClosedTombstone): Boolean =
    ...
    internal fun terminalWritable(checkpoint: RelayV2TerminalCheckpoint): Boolean =
    ...
    internal fun canStartParserDispatch(checkpoint: RelayV2TerminalCheckpoint): Boolean =
        checkpoint.pendingParserEffectHandoff == null &&
            checkpoint.pendingParserEffectActivation == null &&
            canDispatchParser(checkpoint)
    ...
    internal fun validParserContinuity(value: String): Boolean =
        value.isNotBlank() &&
