...
No UI or command producer is wired to that authority, and there is still no end-to-end
server/host v2 runtime, capability advertisement, enrollment, terminal, or
Agent delivery, so Relay v2 remains unavailable as a complete production
feature.
