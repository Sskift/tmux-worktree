...
- [Relay Agent extension v1](docs/relay-agent-transcript-lifecycle-extension-v1.md): frozen optional-extension fixtures plus unwired Node host authority and Android lifecycle/notification reducer foundations. Durable store continuity/retention, public codecs/replay runtime, Android Room/actor integration, G4, and capability advertisement remain pending.
