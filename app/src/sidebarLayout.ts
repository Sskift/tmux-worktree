...
export const SIDEBAR_AUTOMATIONS_MIN_HEIGHT = 40;
export const SIDEBAR_AUTOMATIONS_DEFAULT_HEIGHT = 132;
export const SIDEBAR_STABLE_LAYOUT_MIN_HEIGHT =
...
export function isStableSidebarLayoutHeight(totalHeight: number): boolean {
  return finiteOr(totalHeight, 0) >= SIDEBAR_STABLE_LAYOUT_MIN_HEIGHT;
}
