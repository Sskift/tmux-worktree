...
| Agent 入站 transcript | 不支持 | 不伪造；v2 selected-Session cut 未协商时投影为空 | 不属于冻结基础 slice | 结构化 entry、cursor、重放与去重 |
