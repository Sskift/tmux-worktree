...
| `src/feishuBridge*.ts`, `src/feishuReplyCard.ts`, `src/larkCliBridge.ts` | 独立 Feishu binding/event/turn/reply daemon、CoT/Markdown result adapter 与 Card JSON 2.0 lifecycle/status builder；不调用 Relay transport |
