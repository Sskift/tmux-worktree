...
| `src/relay/v2/` | 未接入 runtime 的 Relay v2 strict codec、Broker/Host carrier foundations、H0 事务状态库、H1 command-plane core 与 process-scoped H3 terminal core；尚无完整生产 adapter/composition wiring，不宣告 capability |
