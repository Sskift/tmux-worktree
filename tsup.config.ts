...
export default defineConfig({
  entry: [
    ...
    "src/relay/v2/brokerClientWssNodeListenerFreeIngress.ts",
    "src/relay/v2/brokerHostWssAdapter.ts",
    "src/relay/v2/brokerHostWssRuntimeComposition.ts",
  ...
  external: [
    ...
    "./brokerClientWssRuntimeComposition.js",
    "./carrierPump.js",
    "./hostCarrier.js",
    ...
    "./resourceState.js",
    "./terminalManager.js",
    "./terminalDurableLineage.js",
    // relayHost dynamically loads the canonical owner entry so H2's private
