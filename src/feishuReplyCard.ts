...
export function neutralizeFeishuMentions(value: string): string {
...
/**
 * Build the bounded Card JSON 2.0 status/recovery payload used by the Bridge.
...
export function buildFeishuReplyCard(
  ...
  return {
    ...
    body: {
      ...
      elements: [{
        tag: "markdown",
        content: neutralizeFeishuMentions(text),
        text_align: "left",
        text_size: "normal",
      }],
    },
